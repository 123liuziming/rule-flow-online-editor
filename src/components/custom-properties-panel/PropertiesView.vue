        ...
        <div v-else>
            ...
            <fieldset class="element-item"
                ...
                <div>
                    ...
                    <div>
                        <div><b>性别:</b></div>
                        <el-radio @change="onConditionChange(element)" v-model="element.sex" label="Sex.MALE">男</el-radio>
                        <el-radio @change="onConditionChange(element)" v-model="element.sex" label="Sex.FEMALE">女</el-radio>
                    </div>
